...
4. **Repository access** で **All repositories**
5. https://cursor.com/agents → 新規 Agent → 検索欄に **`syokugyo`**
...
GitHub アプリで `girinoguchi/syokugyo` の Pull Request を開き、コメントで **`@cursor`** と指示を書く。一覧に出なくても動くことがあります。
